...
public class DepthImageViewer : MonoBehaviour 
{
	...
	void Start () 
	{
        ...
        foregroundOfs = new Vector2(0, (cameraRect.height - rectHeight) / 2);
        foregroundRect = new Rect(0, cameraRect.height - foregroundOfs.y, cameraRect.width, -rectHeight);
		...
		for(int i = 0; i < numColliders; i++)
		{
            ...
            jointColliders[i].AddComponent<BoxCollider2D>();
            jointColliders[i].AddComponent<BodyPartObject>();
		}
	}
